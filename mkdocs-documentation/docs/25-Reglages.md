...
NB : Toutes les modifications effectuées dans la page `Réglages` sont instantannément enregistréesVoir [Synthèse vocale](#synthese-vocale) Il n'est pas nécessaire de chercher un bouton "sauvegarder mes réglages" !
...
**_ATTENTION_** : à utiliser avec précaution.
...
Elle ne supprime que les fichiers produits par l'application : les fichiers photo, videos, autios dont le nom commence par ECM\_.
...
Illustration version Android v1 (_description obsolète à mettre à jour_)
