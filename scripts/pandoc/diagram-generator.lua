...
io.stderr:write(string.format(">>> plantumlPath :  '%s' \n", plantumlPath))
...
io.stderr:write(string.format(">>> pythonPath :  '%s' \n", pythonPath))
...
io.stderr:write(string.format(">>> pythonActivatePath :  '%s' \n", pythonActivatePath))
...
io.stderr:write(string.format(">>> javaPath :  '%s' \n", javaPath))
...
function Meta(meta)
    ...
    io.stderr:write(string.format(">>> meta.plantumlPath :  '%s' \n", meta.plantumlPath))
    io.stderr:write(string.format(">>> meta.pagetitle :  '%s' \n", meta.pagetitle))
    io.stderr:write(string.format(">>> meta.pythonPath :  '%s' \n", meta.pythonPath))
    io.stderr:write(string.format(">>> meta.activatePythonPath :  '%s' \n", meta.activatePythonPath))
...
local function plantuml(puml, filetype)
    io.stderr:write(string.format(">>> plantumlPath :  '%s' \n", plantumlPath))
    io.stderr:write(string.format(">>> filetype :  '%s' \n", filetype))
    io.stderr:write(string.format(">>> puml :  '%s' \n", puml))
